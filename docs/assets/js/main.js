(function(global, factory) {
    ...
    var Togglable = {
        ...
        methods: {
            ...
            _toggleElement: function(el, show, animate$$1) {
                ...
                var promise = (animate$$1 === false || !this.hasAnimation ? this._toggleImmediate : this.hasTransition ? this._toggleHeight : this._toggleAnimation)(el, show);
    ...
    var Grid = {
        ...
        update: [ {
            read: function(ref) {
                ...
                var hasStaticContent = rows.some(function(elements) {
                    return elements.some(function(element) {
                        return css(element, "position") === "static";
                    });
                });
                ...
                return {
                    ...
                    height: hasStaticContent ? elHeight : false
                };
            },
            write: function(ref) {
    ...
    var HeightMatch = {
        ...
        update: {
            read: function() {
                ...
                return {
                    rows: !this.row ? [ this.match(this.elements) ] : getRows(this.elements).map(function(elements) {
    ...
    var HeightViewport = {
        ...
        update: {
            ...
            write: function(ref) {
                ...
                var height$$1;
                if ((height$$1 = Math.round(toFloat(css(this.$el, "minHeight")))) >= offsetHeight(this.$el)) {
    ...
    var Modal = {
        ...
        methods: {
            ...
            hide: function() {
                return this.isToggled() ? this.toggleNow(this.$el, false) : Promise.resolve();
            },
            getActive: function() {
                return active$1;
            },
